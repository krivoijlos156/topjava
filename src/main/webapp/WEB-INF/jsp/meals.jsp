            ...
            <div class="card border-dark">
                    ...
                    <form id="filter">
                        <div class="row">
                            ...
                            <div class="offset-2 col-2">
                                ...
                                <input class="form-control" name="endTime" id="startTime" autocomplete="off">
                            </div>
                            <div class="col-2">
                                <label for="endTime"><spring:message code="meal.startTime"/></label>
                ...
                <div class="card-footer text-right">
                    ...
                    <button class="btn btn-primary" onclick="updateFilteredTable()">
                        ...
                        <%--                                        <button type="submit"><spring:message code="meal.filter"/></button>&ndash;%&gt;&ndash;%&gt;--%>
                    </button>
                </div>
            </div>
            <br>
